...
<tr >
  <td id="td">Professional Field : </td>
  <td><input type="text" value="<?php echo $mD['domaine'] ?>" name="domaine"></td>
</tr>
<tr>
  <td id="td"> Current position : </td>
  <td><input type="text" value="<?php echo $mD['poste'] ?>" name="poste"></td>
</tr>
<tr>
  <td id="td">Skills: </td>
  <td><input type="text" value="<?php echo $mD['competence'] ?>" name="competence"></td>
</tr>
</table> 
<?php else: ?>
